export const createBookSuccMd = `🥳 책 정보 저장을 성공하였습니다.`;
export const createBookDescriptionMd = `
### 💬 책의 정보를 저장하는 API입니다.
...
export const findBookByIdSuccMd = `🥳 ID에 따른 책의 정보를 가져오기에 성공하였습니다.`;
export const findBookByIdDescriptionMd = `
### 💬 책 ID와 일치하는 정보를 가져오는 API입니다.

`;
export const findBookByIdSummaryMd = `✅ ID에 따른 책의 정보를 가져오는 API입니다.`;
